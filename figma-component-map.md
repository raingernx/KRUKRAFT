...
| `Product / Marketplace` | `37:35` | `SearchInput` | `src/design-system/primitives/SearchInput.tsx` | DS primitive | `mapped-manual` | Primitive lives on product page because it is search-led. |
...
| Figma page | Figma node | Figma component | Code path | Owner | Status | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| `Product / Marketplace` | `40:38` | `ResourceCard` | `src/components/resources/ResourceCard.tsx` | Product DS export | `mapped-manual` | Owner is product code, not `src/design-system/components`. |
| `Product / Marketplace` | `37:6` | `PriceBadge` | `src/design-system/components/PriceBadge.tsx` | Product DS export | `mapped-manual` | Still workflow-bound despite DS export. |
| `Product / Marketplace` | `37:11` | `PriceLabel` | `src/design-system/components/PriceLabel.tsx` | Product DS export | `mapped-manual` | THB-oriented label examples in Figma. |
...
These are flow exemplars, not one-to-one Code Connect candidates.

| Figma page | Figma node | Pattern | Backing source | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| `Patterns` | `41:2` | `Admin Settings` | `src/components/settings/*`, `src/app/admin/settings/AdminSettingsClient.tsx` | `mapped-manual` | Anti-nesting and flat-section exemplar. |
| `Patterns` | `41:27` | `Marketplace Discover` | `src/components/marketplace/*`, `src/components/skeletons/*` | `mapped-manual` | Hero search + card row + neutral skeletons. |
| `Patterns` | `41:51` | `Resource Detail` | `src/components/resources/detail/*` | `mapped-manual` | Media-left / purchase-right shell. |
| `Patterns` | `41:74` | `Creator Dashboard` | `src/app/(dashboard)/dashboard/creator/(protected)/*` | `mapped-manual` | Metrics row + single table surface. |
