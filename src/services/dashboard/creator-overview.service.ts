...
export type DashboardCreatorStatKey = "revenue" | "resources" | "downloads";

export interface DashboardCreatorStatItem {
  key: DashboardCreatorStatKey;
  label: string;
  value: string;
  detail: string;
}

export interface DashboardCreatorLinkItem {
  title: string;
  detail: string;
  href: string;
...
export interface DashboardCreatorChecklistItem {
  label: string;
  detail: string;
  done: boolean;
}

export interface DashboardCreatorResourceRow {
  id: string;
  title: string;
  href: string;
  status: string;
...
export interface DashboardCreatorProfileSummary {
  displayName: string;
  slugLabel: string;
...
type DashboardCreatorOverviewUnavailableData =
  | {
      state: "locked";
      title: string;
      description: string;
...
export type DashboardCreatorOverviewData =
  | {
      state: "ready";
      creatorName: string;
      activationStage: "first-run" | "active";
      stats: DashboardCreatorStatItem[];
      links: DashboardCreatorLinkItem[];
      checklist: DashboardCreatorChecklistItem[];
      totalResourceCount: number;
      resources: DashboardCreatorResourceRow[];
      profile: DashboardCreatorProfileSummary;
    }
  | DashboardCreatorOverviewUnavailableData;
...
export async function getDashboardCreatorOverviewData(
  userId: string,
  options: {
    access?: CreatorAccessState;
  } = {},
): Promise<DashboardCreatorOverviewData> {
  try {
