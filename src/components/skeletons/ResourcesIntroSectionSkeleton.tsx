      ...
      <div className="space-y-5">
          ...
          <div className="max-w-2xl space-y-2">
            ...
            {isDiscoverMode ? (
              <div className="space-y-2">
                <LoadingSkeleton className="h-8 w-full max-w-[680px] rounded-xl sm:h-10" />
                <LoadingSkeleton className="h-8 w-4/5 max-w-[520px] rounded-xl sm:h-10" />
              </div>
            ) : (
            ...
            {isDiscoverMode ? (
              <div className="space-y-2 pt-1">
                <LoadingSkeleton className="h-4 w-full max-w-[640px]" />
                <LoadingSkeleton className="h-4 w-5/6 max-w-[560px]" />
              </div>
            ) : null}
          </div>

          <div className="flex flex-wrap gap-2">
            <LoadingSkeleton className="h-6 w-24 rounded-full border border-surface-200 bg-surface-50" />
            <LoadingSkeleton className="h-6 w-24 rounded-full border border-surface-200 bg-surface-50" />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between lg:gap-6">
          <div className="flex min-w-0 items-center gap-3 overflow-hidden sm:gap-4">
            <LoadingSkeleton className="h-9 w-24 shrink-0 rounded-lg" />
          ...
          <LoadingSkeleton className="h-11 w-full shrink-0 rounded-2xl border border-surface-200 bg-white shadow-sm lg:max-w-lg" />
        </div>
      </div>
    </section>
  );
