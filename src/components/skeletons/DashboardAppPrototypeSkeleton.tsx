...
export function DashboardAppPrototypeSkeleton() {
  return (
    <div className="min-h-dvh bg-background text-foreground">
      <div className="flex min-h-dvh">
        <SidebarSkeleton />
...
export function DashboardNeutralRouteSkeleton() {
  return (
    <DashboardPageSkeletonShell>
      <div className="flex flex-col gap-8" data-loading-scope="dashboard-neutral">
        <section className="border-b border-border-subtle pb-6">
          <LoadingSkeleton className="h-5 w-24 rounded-full" />
...
export function DashboardCreatorNeutralRouteSkeleton() {
  return (
    <DashboardPageSkeletonShell>
      <div
        className="flex flex-col gap-8"
        data-loading-scope="dashboard-creator-neutral"
      >
        <section className="border-b border-border-subtle pb-6">
...
export function DashboardRouteContentSkeleton({
  variant = "home",
}: {
  variant?:
    | "home"
  ...
  return (
    <DashboardPageSkeletonShell>
      <DashboardRouteContentSkeletonBody variant={variant} />
    </DashboardPageSkeletonShell>
  );
}

function DashboardRouteContentSkeletonBody({
  variant = "home",
}: {
  variant?:
    | "home"
  ...
  if (variant === "creator-profile") {
    return (
      <div
        className="flex flex-col gap-8"
        data-loading-scope="dashboard-creator-profile"
      >
        <section className="border-b border-border-subtle pb-6">
          <LoadingSkeleton className="h-5 w-28 rounded-full" />
  ...
  if (variant === "creator-settings") {
    return (
      <div
        className="flex flex-col gap-8"
        data-loading-scope="dashboard-creator-settings"
      >
        <section className="border-b border-border-subtle pb-6">
          <LoadingSkeleton className="h-5 w-32 rounded-full" />
  ...
  if (isCreatorWorkspace) {
    return (
      <div
        className="flex flex-col gap-8"
        data-loading-scope={`dashboard-${variant}`}
      >
        <section className="border-b border-border-subtle pb-6">
          <LoadingSkeleton className="h-5 w-28 rounded-full" />
  ...
  if (isHomeRoute) {
    return (
      <div className="flex flex-col gap-8" data-loading-scope="dashboard-home">
        <section className="border-b border-border-subtle pb-6">
  ...
  if (isLibraryRoute) {
    return (
      <div className="flex flex-col gap-8" data-loading-scope="dashboard-library">
        <section className="border-b border-border-subtle pb-6">
          <LoadingSkeleton className="h-5 w-16 rounded-full" />
          <LoadingSkeleton className="mt-4 h-10 w-full max-w-md rounded-2xl" />
          <LoadingSkeleton className="mt-3 h-4 w-full max-w-xl" />
  ...
  if (isDownloadsRoute) {
    return (
      <div
        className="flex flex-col gap-8"
        data-loading-scope="dashboard-downloads"
      >
        <section className="border-b border-border-subtle pb-6">
          <LoadingSkeleton className="h-5 w-20 rounded-full" />
          <LoadingSkeleton className="mt-4 h-10 w-full max-w-md rounded-2xl" />
  ...
  if (isPurchasesRoute) {
    return (
      <div
        className="flex flex-col gap-8"
        data-loading-scope="dashboard-purchases"
      >
        <section className="border-b border-border-subtle pb-6">
          <LoadingSkeleton className="h-5 w-20 rounded-full" />
          <LoadingSkeleton className="mt-4 h-10 w-full max-w-md rounded-2xl" />
  ...
  if (isMembershipRoute) {
    return (
      <div
        className="flex flex-col gap-8"
        data-loading-scope="dashboard-membership"
      >
        <section className="border-b border-border-subtle pb-6">
          <LoadingSkeleton className="h-5 w-24 rounded-full" />
          <LoadingSkeleton className="mt-4 h-10 w-full max-w-md rounded-2xl" />
  ...
  if (variant === "creator-resources") {
    return (
      <div
        className="flex flex-col gap-8"
        data-loading-scope="dashboard-creator-resources"
      >
        <section className="border-b border-border-subtle pb-6">
          <LoadingSkeleton className="h-5 w-32 rounded-full" />
          <LoadingSkeleton className="mt-4 h-10 w-full max-w-lg rounded-2xl" />
  ...
  if (variant === "creator-analytics") {
    return (
      <div
        className="flex flex-col gap-8"
        data-loading-scope="dashboard-creator-analytics"
      >
        <section className="border-b border-border-subtle pb-6">
          <LoadingSkeleton className="h-5 w-32 rounded-full" />
          <LoadingSkeleton className="mt-4 h-10 w-full max-w-lg rounded-2xl" />
  ...
  return (
    <div className="flex flex-col gap-8" data-loading-scope={`dashboard-${variant}`}>
      <section className="border-b border-border-subtle pb-6">
        <LoadingSkeleton className="h-5 w-28 rounded-full" />
