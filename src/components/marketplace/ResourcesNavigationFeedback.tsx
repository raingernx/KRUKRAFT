  ...
  return (
    ...
    >
      <div className="relative h-1.5 overflow-hidden border-b border-brand-200/60 bg-brand-100/80 shadow-[0_1px_0_rgba(255,255,255,0.65)]">
        ...
        <div className="resources-feedback-shimmer absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-transparent via-white/70 to-transparent opacity-80" />
      </div>
      <style jsx>{`
        .resources-feedback-shimmer {
          animation: resources-feedback-shimmer 1.1s linear infinite;
        }

        @keyframes resources-feedback-shimmer {
          from {
