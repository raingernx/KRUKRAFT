...
const selectBase =
  "h-10 w-full rounded-lg border border-neutral-200 bg-white px-3 text-sm text-zinc-900 outline-none transition duration-150 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 focus:ring-offset-0 appearance-none bg-no-repeat bg-[length_14px] bg-[right_0.75rem_center] disabled:cursor-not-allowed disabled:bg-zinc-50 disabled:opacity-60";
