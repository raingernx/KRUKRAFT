...
type DashboardMembershipActionsProps = {
  primaryHref: string;
  primaryLabel: string;
...
export function DashboardMembershipActions({
  primaryHref,
  primaryLabel,
  secondaryHref,
  secondaryLabel,
  ...
  subscriptionState,
}: DashboardMembershipActionsProps) {
  ...
  useEffect(() => {
    ...
    router.replace(routes.dashboardMembership);
