...
export const typography = {
  ...
  scale: {
    ...
    titleSm: {
      ...
      weight: "font-semibold",
      fontSize: fontSizeScale["title-sm"][0],
      lineHeight: fontSizeScale["title-sm"][1].lineHeight,
      letterSpacing: letterSpacingScale.heading,
      fontWeight: fontWeights.heading,
    },
    bodyLg: {
    ...
    label: {
      ...
      weight: "font-semibold",
      fontSize: fontSizeScale.label[0],
      lineHeight: fontSizeScale.label[1].lineHeight,
