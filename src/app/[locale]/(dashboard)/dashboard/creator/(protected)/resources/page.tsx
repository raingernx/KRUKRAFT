          ...
          {data.resources.length === 0 ? (
            hasActiveFilters ? (
              <div className="px-6 py-16 text-center">
                ...
                <Link
                  href={routes.creatorResources}
                  className="mt-4 inline-flex items-center rounded-xl border border-neutral-200 px-4 py-2 text-sm font-medium text-neutral-600 hover:bg-neutral-50"
                >
                  Clear filters
                </Link>
              </div>
              ...
              <div className="px-6 py-16 text-center">
                ...
                <p className="mt-4 text-sm font-semibold text-neutral-800">No resources yet</p>
                ...
                {access.canCreate && (
                  <Link
                    href={routes.creatorNewResource}
                    className="mt-6 inline-flex items-center gap-2 rounded-xl bg-neutral-900 px-4 py-2.5 text-sm font-semibold text-white hover:bg-neutral-800"
                  >
                    <Plus className="h-4 w-4" />
