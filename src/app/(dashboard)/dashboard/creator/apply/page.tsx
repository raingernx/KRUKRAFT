...
export default async function DashboardCreatorApplyPage() {
  const { userId, session } = await requireSession(routes.dashboardCreatorApply);

  if (session.user.role === "ADMIN" || session.user.role === "INSTRUCTOR") {
    redirect(routes.dashboardCreator);
  }
