...
- `/admin/creators` now renders its header shell first and streams the creator-application table behind an in-page `Suspense` fallback instead of blocking the whole route on the application list
