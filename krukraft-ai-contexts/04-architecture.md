...
- repo-owned scripts now operationalize the layer: `wiki:ingest` adds raw notes and optional wiki stubs, `wiki:index` regenerates the navigation file, and `wiki:stale` flags old pages for review
