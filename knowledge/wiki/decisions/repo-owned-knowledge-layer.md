...
- `wiki:ingest:batch` and `wiki:ingest:batch:dry-run` support multi-source ingest plans and show batch-level merge/backlink summaries before the batch lands.
